...
public class FilmConroller {
		...
		/*
		@RequestMapping(value="/chercher/{keyword}" ,method=RequestMethod.GET)
		public List<Film> getByGenre(ModelMap modelMap,@PathVariable("keyword") String keyword)
		{
			return filmService.findByGenre(keyword);
			
		}
		*/
		/*
		@RequestMapping("/chercher")
		public String getByGenre(ModelMap modelMap,@RequestParam("keyword") Genre genre)
		{
		...
		public Film getByGenre(@PathVariable("id") Long id) {
